...
| **2. Audio Keyword Hunt**                            | Develop vocabulary and listening skills                   | **1.** Summarize the text to get the gist before reading the full content.<br>**2.** Discuss keywords in groups using an online dictionary. <br>**3.** Submit keywords via [Google Form](https://forms.gle/uyBgxdJQgPVdK2DZ8).<br>**4.** Generate live keyword cloud.| 🎯**App#1**-[Online Dictionary](https://huggingface.co/spaces/verastudio/Online_Dictionary)<br>🎯**App#2**-[Keyword Cloud](https://huggingface.co/spaces/verastudio/keywordcloud)| 5 mins  |
