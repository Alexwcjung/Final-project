...
|---------------------------------------------------|-----------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|----------|
| **1. Warm-Up**                                       | Activate prior knowledge and introduce the topic          | Ask students if they have seen a lighthouse and its purpose                                                                                              |                                                                                                     | 3 mins  | # My Video [Video](https://github.com/Alexwcjung/alex/blob/main/202412222054%20(1).mp4)

| **2. Audio Keyword Hunt**                            | to help students grasp the main idea of a text quickly before engaging with the full content                   | **1.** Summarize the text to get the gist before reading the full content.<br>**2.** Discuss keywords in groups using an online dictionary. <br>**3.** Submit keywords via [Google Form](https://forms.gle/uyBgxdJQgPVdK2DZ8).<br>**4.** Generate live keyword cloud.| 🎯**App#1**-[Summarize the text](https://alexwcjung.streamlit.app/App:_Summarize-the-text)<br>🎯**App#2**-[Keyword Cloud](https://huggingface.co/spaces/verastudio/keywordcloud)| 5 mins  |
