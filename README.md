...
|---------------------------------------------------|-----------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|----------|
| **1. Warm-Up**                                    | Activate prior knowledge and introduce the topic          | - Show My Video ([Click Here to Watch](https://github.com/Alexwcjung/alex/blob/main/202412222054%20(1).mp4)).<br>- Briefly discuss its connection to the lesson.                                                                 |                                                                                                 | 3 mins   |
| **2. Audio Keyword Hunt**                         | Help students grasp the main idea of the text before reading | **1.** Play a short audio excerpt.<br>**2.** Students summarize the gist.<br>**3.** Discuss and find keywords in groups using an online dictionary.<br>**4.** Submit keywords via [Google Form](https://forms.gle/uyBgxdJQgPVdK2DZ8).<br>**5.** Generate a live keyword cloud. | 🎯**App#1**-[Summarize the Text](https://alexwcjung.streamlit.app/App:_Summarize-the-text)<br>🎯**App#2**-[Keyword Cloud](https://huggingface.co/spaces/verastudio/keywordcloud) | 5 mins   |
| **3. Story Listening I - Reconstruction**         | Enhance comprehension through visual aids and collaboration | **1.** Play the full story audio.<br>**2.** Students listen to the story and arrange pictures in the correct order.<br>**3.** Review the correct sequence with the class.                                                                 | 🎯**App#3**-[Story Order](https://huggingface.co/spaces/verastudio/Story_Order)                 | 10 mins  |
| **4. Story Listening II - Relay Writing with Keywords** | Reinforce comprehension and writing skills using keywords  | **1.** Review images from the reconstruction activity.<br>**2.** Each student selects a keyword from the Keyword Cloud.<br>**3.** Students write a description of the images sequentially on [Padlet](https://padlet.com/mirankim316/introduction-to-coding-and-language-app-design-tesol-spring--njwe895ytgl83hhu). | 🎯**App#2**-[Keyword Cloud](https://huggingface.co/spaces/verastudio/keywordcloud)              | 7 mins   |
| **5. Writing a Letter to Grandpa**                | Practice formal writing and comprehension through a structured activity | **1.** Write thank-you letters using **Letter Maker 1**.<br>**2.** Listen to Grandpa’s voice email.<br>**3.** Answer questions using a multiple-choice quiz app.                                                                 | 🎯**App#4.1**-[Letter Maker 1](https://huggingface.co/spaces/verastudio/Letter_Maker1)<br>🎯**App#5**-[Quiz App](https://huggingface.co/spaces/verastudio/Multiple_Choice) | 10 mins  |
| **6. Writing a Letter to the Grandson**           | Develop independent writing skills through a less structured activity | **1.** Write thank-you letters using **Letter Maker 2**.<br>**2.** Post letters on [Padlet](https://padlet.com/mirankim316/introduction-to-coding-and-language-app-design-tesol-spring--njwe895ytgl83hhu).<br>**3.** Leave feedback on peers’ letters.                 | 🎯**App#4.2**-[Letter Maker 2](https://huggingface.co/spaces/verastudio/Letter_Maker2)          | 10 mins  |
